...
ifndef::snapshot[]
* link:https://github.com/hazelcast/hazelcast/blob/v{minor-version}/hazelcast/src/main/resources/hazelcast-full-example.xml[hazelcast-full-example.xml]
* link:https://github.com/hazelcast/hazelcast/blob/v{minor-version}/hazelcast/src/main/resources/hazelcast-full-example.yaml[hazelcast-full-example.yaml]
endif::[]
====
